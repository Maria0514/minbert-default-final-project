...
def model_eval_multitask(sentiment_dataloader,
    ...
    return paraphrase_accuracy, sts_corr, accuracy_score(sst_y_true, sst_y_pred)
...
def test_model_multitask(args, model, device):
    ...
    dev_paraphrase_accuracy, dev_sts_corr, dev_sentiment_accuracy = model_eval_multitask(
